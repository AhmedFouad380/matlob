...
@section('breadcrumb')
    <h1 class="d-flex text-dark fw-bolder my-1 fs-3">تعديل بيانات الصفحة التعريفية</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <li class="breadcrumb-item text-gray-500">تعديل بيانات الصفحة التعريفية</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">تعديل بيانات الصفحة التعريفية</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="title"
                                       ...
                                       placeholder="الاسم" value="{{$employee->title}}"  required/>
