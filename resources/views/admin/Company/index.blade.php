    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('Companies.datatable.data') }}',
                    data: {
                ...
                columns: [
                    ...
                    {data: 'company_name', name: 'name', "searchable": true, "orderable": true},
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-Companies')}}",
