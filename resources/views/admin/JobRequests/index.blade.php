...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-600">
            <a href="{{ url('/JobSetting') }}" class="text-gray-600 text-hover-primary">الوظائف</a>
        </li>
        <li class="breadcrumb-item text-gray-500">المتقدمين للوظيفة</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('JobRequests.datatable.data') }}',
                    data: {
                        id:{{$id}}
                    }
                },
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-JobRequests')}}",
